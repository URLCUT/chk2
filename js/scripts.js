        ...
        function startchk(url) {
            ...
            $.ajax({
                ...
                url: 'api.php',
                type: 'GET',
                data: 'lista=' + url + '&city=' + document.getElementById('city').value + '&country=' + document.getElementById('country').value + '&state=' + document.getElementById('state').value + '&zipcode=' + document.getElementById('zipcode').value ,
